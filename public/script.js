...
//         console.log("called broadcast 1..");
...
//         ue.interface = {};
//         ue.interface.broadcast = function (name, data) {
//             console.log("called broadcast 2..");
//             if (typeof name != "string")
//                 return;
//             if (typeof data != "undefined")
...
// unity = {};
// (function (obj) {
//     unity.postMessage = function (data) {
...
//     };
// })(unity);
function testTransfer(arguments) {
    console.log(`inside testTrasfer ${arguments}`);
    return `this is what`;
}

function initImmutable() {
    registerFunction(testTransfer);
}

function callFunction(request) {
    console.log(`callFunction request: ${request}`);
    transfer("transactionHashA");
}

function callFunction2() {
    console.log(`this2: ${this}`);
    transfer("transactionHashB");
}
